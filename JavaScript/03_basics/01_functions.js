...
//To avoid case of no arguments being passed, we can actually define a defalut value in the function declaration, so that if no value is passed as argument, there is a default value defined already. But if a value is passed then that default value will be overwritten by the argument passed.
