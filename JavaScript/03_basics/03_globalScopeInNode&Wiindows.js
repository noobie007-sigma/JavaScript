//In Javascript, the global scope refers to the outermost scope where variables and functions are accessible from any part of the code. However, behaviour of global scope varies according to the environment in which JS is running.
