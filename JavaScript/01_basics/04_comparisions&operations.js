...
/*
 ...
 3) Comparisons(<, >, <=, >=):
     ...
     ii. If both operands are strings, lexicographic(dictionary) comparison is performed.
 ...
 4) Equality(==, ===, !=, !==):
     i. If both operands are of same type, then no confusions.
     ii. If one is string, other is number, string is converted to number.
     iii. If one operand is an object, and other is a primitive, the object is converted to primitive.
...
/*
  i.  Postix operation: It returns the value, then performs increment operation.
  ii. Prefix operation: It first performs increment operation, then returns the incremented value.

*/

console.log(null == undefined) // null and undefined are loosely equal to each other
console.log(null === undefined) // but not strictly equal 
