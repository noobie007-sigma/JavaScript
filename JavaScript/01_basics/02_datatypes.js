...
const id = Symbol('123') //Although it is not required to give description to a Symbol, but if you give, it must be a string i.e. enclosed within quotes.
//Primary purpose of description in a symbol is for identification and debugging purposes, it doesn't affect the uniqueness of Symbol, even if we give same description to more than 1 symbols. Each Symbol returns a unique symbol-value which makes it unique.
const anotherId = Symbol('123')
console.log(id === anotherId); //false



//These are 7 primitive datatypes: number, string, null, undefined, symbol, boolean, BigInt.
