...
//Number(): It converts the passed arguments into number datatype. If the string value passed is not a valid number representation, it return NaN i.e. Not a Number. Also an empty string "" gets converted to 0.
...
//Falsy Values: ""(empty string), 0, null, undefined, NaN, false.

//Empty arrays and empty objects are also truthy.
console.log(Boolean({}))
console.log(Boolean([]))
