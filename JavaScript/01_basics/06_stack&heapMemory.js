/*
In JavaScript, memory management is handled automatically by the runtime environment, and developers don't have direct control over memory allocation and de-allocation. However, it's helpful to understand the concepts of stack and heap memory to gain insights into how memory is managed in the background.
...
In JavaScript, primitive datatypes like numbers and booleans are typically stored in the stack, while objects are stored in the heap. When you create an object in JavaScript, it is allocated memory in the heap, and a reference to that memory location is stored in the stack or other objects.
*/
