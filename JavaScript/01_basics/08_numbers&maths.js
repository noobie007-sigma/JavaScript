...
console.log(`${decimalNumber.toFixed(2)}   ${typeof decimalNumber.toFixed(2)}   ${decimalNumber.toFixed()}`); //toFixed() rounds off the number passed, to specified number of decimal places. If no argument is passed, it modifies it to nearest integer, 124 in this case. It returns a string, not a number.
...
console.table(["Some Math Properties", Math.E, Math.PI, Math.SQRT2, "etc"])
